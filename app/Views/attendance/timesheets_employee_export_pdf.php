...
<body>
    ...
    <div>
        <p class="col-lg-6 fw-bold">Employee : <?= $employee_detail['f_name'] . ' ' . $employee_detail['m_name'] . ' ' . $employee_detail['l_name']; ?></p>
        <p class="col-lg-6 fw-bold">Batch ID : <?= $employee_detail['batch_id']; ?></p>
        <p class="col-lg-6 fw-bold">Department : <?= $department_name; ?></p>
        <p class="col-lg-6 fw-bold">Shift : <?= $employee_detail['shift']; ?></p>
    </div>
